...
class _BarcodeScannerPageState extends State<BarcodeScannerPage> with SingleTickerProviderStateMixin {
    ...
    if (barcodes.isNotEmpty) {
      ...
      if (code.isNotEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Successfully scanned: $code'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: widget.standalone ? AppBar(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: Colors.black.withOpacity(0.5), spreadRadius: 10000),
                        ],
                      ),
                    ),
                    // Animated Line
                        ...
                        return Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: AppColors.success.withOpacity(0.8), blurRadius: 10, spreadRadius: 2),
                              ],
                            ),
                          ),
                        );
